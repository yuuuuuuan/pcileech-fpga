#
# Vivado .tcl for creating the pcileech_75t484_x1_i219lm Vivado project.
# Device profile: Intel I219-LM Gigabit Ethernet (8086:156F, Lenovo ThinkPad)
# Derived from 75t484_x1 (Intel 7-series HD Audio); only 3 files are modified:
#   ip/pcie_7x_0.xci          - PCIe IP core identity (DID/Class/SubVen/SubDev)
#   ip/pcileech_cfgspace.coe  - Configuration space BRAM contents
#   src/pcileech_pcie_cfg_a7.sv - DSN value
# All other source/IP files are shared from ../75t484_x1/.
...
# Shared source directory: unchanged files from the base 75t484_x1 variant
set shared_dir "[file normalize "${origin_dir}/../75t484_x1"]"


# Set the project name
set _xil_proj_name_ "pcileech_75t484_x1_i219lm"
...
set script_file "vivado_generate_project_captaindma_75t_i219lm.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/pcileech_75t484_x1_i219lm"]"
...
set files [list \
 [file normalize "${shared_dir}/src/pcileech_header.svh"]\
 [file normalize "${shared_dir}/src/pcileech_com.sv" ]\
 [file normalize "${shared_dir}/src/pcileech_fifo.sv"]\
 [file normalize "${shared_dir}/src/pcileech_ft601.sv"]\
 [file normalize "${shared_dir}/src/pcileech_mux.sv"]\
 [file normalize "${shared_dir}/src/pcileech_pcie_a7.sv"]\
 [file normalize "${origin_dir}/src/pcileech_pcie_cfg_a7.sv"]\
 [file normalize "${shared_dir}/src/pcileech_pcie_tlp_a7.sv"]\
 [file normalize "${shared_dir}/src/pcileech_tlps128_bar_controller.sv"]\
 [file normalize "${shared_dir}/src/pcileech_tlps128_cfgspace_shadow.sv"]\
 [file normalize "${shared_dir}/src/pcileech_75t484_x1_top.sv"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/pcileech_bar_zero4k.coe" ]\
 [file normalize "${origin_dir}/ip/pcileech_cfgspace.coe" ]\
 [file normalize "${shared_dir}/ip/pcileech_cfgspace_writemask.coe" ]\
 [file normalize "${shared_dir}/ip/bram_pcie_cfgspace.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/drom_pcie_cfgspace_writemask.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_74_74_clk1_bar_rd1.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/bram_bar_zero4k.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_134_134_clk1_bar_rdrsp.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_141_141_clk1_bar_wr.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_134_134_clk2_rxfifo.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_1_1_clk2.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_134_134_clk2.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_64_64_clk1_fifocmd.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_256_32_clk2_comtx.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_32_32_clk1_comtx.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_129_129_clk1.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_64_64.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_32_32_clk2.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_49_49_clk2.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_43_43_clk2.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_34_34.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
# Import local files from the original project
set files [list \
 [file normalize "${shared_dir}/ip/fifo_64_64_clk2_comrx.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
# Set 'sources_1' fileset file properties for remote files
# None
...
set file "[file normalize ${shared_dir}/src/pcileech_75t484_x1_captaindma_75t.xdc]"
